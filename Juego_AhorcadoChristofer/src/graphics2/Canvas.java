...
public class Canvas
{
    ...
    /*
     * Para cuando aciertas en el juego del ahoracado
     */
    public static void acierto()
    {
        JFrame frame = getInstance().frame;
        if (frame == null) return;
        JOptionPane.showMessageDialog(frame, "HAS ACERTADO UNA LETRA...");
    }
    /*
     * Para cuando fallas en el juego del ahorcado
     */
    public static void fallo()
    {
        JFrame frame = getInstance().frame;
        if (frame == null) return;
        JOptionPane.showMessageDialog(frame, "HAS FALLADO...");
    }
    /*
     * Mensaje de bienvenida en el juego del ahorcado
     */
    ...
    public static void bienvenida()
    {
        JFrame frame = getInstance().frame;
        if (frame == null) return;
        JOptionPane.showMessageDialog(frame,  "ESTE ES EL JUEGO DEL AHORCADO.");
    }
    /**
